document.addEventListener('DOMContentLoaded', () => {
    ...
    // Initialize Rings with Random Positions (Avoiding 7s)
    rings.forEach(ring => {
        ...
        // Set Random Start Position (Avoiding 7s - Indices 0 and 6)
        let randomStart;
        do {
    ...
    function triggerJackpot() {
        ...
        // MUSIC START: Fade in from 0
        bgMusic.volume = 0;
        bgMusic.play().catch(() => { console.log("Music blocked"); });
        fadeAudio(bgMusic, 1.0, 5000); // 5s fade in
    ...
    function transitionToScene2() {
        ...
        // Soften music for reading
        fadeAudio(bgMusic, 0.3, 4000);
    ...
    function fadeAudio(audio, targetVolume, duration) {
        ...
        function updateVolume(currentTime) {
            ...
            if (elapsed < duration) {
                audio.volume = startVolume + (change * (elapsed / duration));
